 ...
 */
  ...
  // }
  function add_cors_header() {
    $referrer = isset($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : ''; // Check if HTTP_REFERER exists
    $origin = isset($_SERVER['HTTP_ORIGIN']) ? $_SERVER['HTTP_ORIGIN'] : ''; // Check if HTTP_ORIGIN exists

    if (CORS_DEBUG) error_log('referer: '.$referrer.', origin: '.$origin);
